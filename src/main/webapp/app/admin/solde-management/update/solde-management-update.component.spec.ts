...
describe('User Management Update Component', () => {
  ...
  let fixture: ComponentFixture<SoldeManagementUpdateComponent>;
  let service: UserManagementService;

  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule],
      declarations: [SoldeManagementUpdateComponent],
      providers: [
        FormBuilder,
        {
      ...
      .overrideTemplate(SoldeManagementUpdateComponent, '')
      .compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(SoldeManagementUpdateComponent);
