...
import { TypeCongeManagementComponent } from './type-conge-management.component';

describe('User Management Component', () => {
  let comp: TypeCongeManagementComponent;
  let fixture: ComponentFixture<TypeCongeManagementComponent>;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [TypeCongeManagementComponent],
      providers: [{ provide: ActivatedRoute, useValue: { data, queryParamMap } }, AccountService],
    })
      .overrideTemplate(TypeCongeManagementComponent, '')
      .compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(TypeCongeManagementComponent);
